...
public interface ResourceIdResolver {
	 ...
	 * the implementation is unable to resolve the logical resource id to a physical one based
	 * on the specific resource information available, the logical resource id is returned as
	 * the physical one.
	 * <p>
	 * This resolving mechanism provides no guarantees on existence of the resource denoted by
	 * the resolved physical resource id.
	 * </p>
