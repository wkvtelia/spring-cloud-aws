 ...
 * {@link io.awspring.cloud.cache.config.annotation.EnableElastiCache}
 * annotation to configure cache specific attributes. This annotation allows to
 * explicitly to define the cache names and also to configure further cache
 * specific attributes like the expiration.
 *
 * @author Agim Emruli
...
public @interface CacheClusterConfig {
	 ...
	 * configured then the value of {@link EnableElastiCache#defaultExpiration()}
	 * will be used.
	 */
