...
public class SqsProperties extends AwsClientProperties {
	...
	public static class ListenerProperties {
		...
		/**
		 * The maximum number of messages that should be retrieved during one poll to
		 * the Amazon SQS system. This number must be a positive, non-zero number that
		 * has a maximum number of 10. Values higher then 10 are currently not supported
		 ...
		 * request to the system significantly. The value should be between 1 and 20.
	...
	public static class HandlerProperties {
		...
		/**
		 * Configures global deletion policy used if deletion policy is not explicitly
		 * set on {@link SqsListener}.
		 */
